...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"style"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1),z=JSON.parse('{"title":"控件","description":"","frontmatter":{},"headers":[],"relativePath":"bmap/3.控件.md","filePath":"bmap/3.控件.md","lastUpdated":1708770940000}'),G={name:"bmap/3.控件.md"},N=Object.assign(G,{setup(f){return(e,E)=>{const p=B("demo"),k=B("git-talk");return m(),D("div",null,[b,o(p,{customClass:"",sourceCode:`<template>
...
`},{highlight:A(()=>[O]),default:A(()=>[o(Z)]),_:1}),o(k)])}}});export{z as __pageData,N as default};
