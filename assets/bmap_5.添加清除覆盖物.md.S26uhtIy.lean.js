import{d as v,f as F,av as w,o as f,w as M,u as n,ae as d,V as p,W as r,X as i,_ as B,k as t,$ as y,F as u,af as _,E as s,a5 as L}from"./chunks/framework.bXfzgsRM.js";import{l as P}from"./chunks/map._qUit9OZ.js";const b={class:"box"},G={class:"result"},O={key:0},x={key:1},W=v({__name:"5.添加清除覆盖物.md.demo.45c2dc71",setup(D){const g=F(),h=F("Marker");F();const e=F("102.85076697175514, 24.89248383034783"),{copy:o,copied:A}=w({source:e});f(async()=>{await C(g.value)}),M(h,async c=>{await C(g.value)});async function C(c){const a=await P(),k=new a.Map(c);if(k.centerAndZoom(new a.Point(102.66176448738847,25.095927154191205),18),k.enableScrollWheelZoom(!0),k.addEventListener("click",l=>{e.value=`${l.latlng.lng},${l.latlng.lat}`}),n(h)==="Marker"){k.clearOverlays();const l=new a.Marker(new a.Point(102.66190821626998,25.095869901942454),{enableDragging:!0});l.addEventListener("click",()=>{k.openInfoWindow(new a.InfoWindow("地址：昆明五华区大河埂地铁站",{width:200,height:100,title:"地铁站"}),new a.Point(102.66190821626998,25.095869901942454))}),k.addOverlay(l),k.addOverlay(new a.Marker(new a.Point(102.66232143680443,25.094904597341667),{enableDragging:!0,icon:new a.Icon("https://img1.baidu.com/it/u=2399966577,1808536528&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=492",new a.Size(50,50))}))}else n(h)==="Polyline"?(k.clearOverlays(),k.addOverlay(new a.Polyline([new a.Point(102.65981516443243,25.09663886789298),new a.Point(102.66192618238017,25.095943526553533),new a.Point(102.6613063515785,25.09422560728852)],{strokeColor:"red",strokeWeight:2,strokeOpacity:.5}))):n(h)==="Circle"?(k.clearOverlays(),k.addOverlay(new a.Circle(new a.Point(102.66190821626998,25.095869901942454),100,{strokeColor:"blue",strokeWeight:2,strokeOpacity:.5}))):n(h)==="Polygon"&&(k.clearOverlays(),k.addOverlay(new a.Polygon([new a.Point(102.66078533438288,25.09687610108273),new a.Point(102.66358804757309,25.09598442909589),new a.Point(102.66308499648767,25.094708263260046),new a.Point(102.66003075775475,25.095616305716906)],{strokeColor:"blue",strokeWeight:2,strokeOpacity:.5,backgroundColor:"black"})))}return(c,a)=>{const k=d("AButton"),l=d("a-select-option"),m=d("a-select");return p(),r(u,null,[i("div",b,[i("div",G,B(e.value),1),t(k,{onClick:a[0]||(a[0]=E=>n(o)())},{default:y(()=>[n(A)?(p(),r("span",x,"已复制")):(p(),r("span",O,"复制"))]),_:1})]),i("div",{id:"container",class:"container",ref_key:"container",ref:g},null,512),t(m,{value:h.value,"onUpdate:value":a[1]||(a[1]=E=>h.value=E),style:{"margin-top":"20px"}},{default:y(()=>[(p(),r(u,null,_(["Marker","Polyline","Circle","Polygon","Label","Marker3D"],E=>t(l,{value:E},{default:y(()=>[s(B(E),1)]),_:2},1032,["value"])),64))]),_:1},8,["value"])],64)}}}),I=L(W,[["__scopeId","data-v-4cef1af3"]]),$=i("h1",{id:"添加清除覆盖物",tabindex:"-1"},[s("添加清除覆盖物 "),i("a",{class:"header-anchor",href:"#添加清除覆盖物","aria-label":'Permalink to "添加清除覆盖物"'},"​")],-1),S=i("div",{class:"language-vue vp-adaptive-theme"},[i("span",{class:"lang"},"vue"),i("pre",{class:"shiki shiki-themes github-light github-dark vp-code","v-pre":""},[i("code",null,[i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"<"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"template"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),s(`
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"    <"),i("span",{style:{"--shiki-light":"#B31D28","--shiki-dark":"#FDAEB7","--shiki-light-font-style":"italic","--shiki-dark-font-style":"italic"}},"AButton"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}}," @"),i("span",{style:{"--shiki-light":"#6F42C1","--shiki-dark":"#B392F0"}},"click"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"="),i("span",{style:{"--shiki-light":"#032F62","--shiki-dark":"#9ECBFF"}},'"'),i("span",{style:{"--shiki-light":"#6F42C1","--shiki-dark":"#B392F0"}},"copy"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"()"),i("span",{style:{"--shiki-light":"#032F62","--shiki-dark":"#9ECBFF"}},'"'),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),s(`
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"    }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"style"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1),N=JSON.parse('{"title":"添加清除覆盖物","description":"","frontmatter":{},"headers":[],"relativePath":"bmap/5.添加清除覆盖物.md","filePath":"bmap/5.添加清除覆盖物.md","lastUpdated":1708770940000}'),Z={name:"bmap/5.添加清除覆盖物.md"},V=Object.assign(Z,{setup(D){return(g,h)=>{const e=d("demo"),o=d("git-talk");return p(),r("div",null,[$,t(e,{customClass:"",sourceCode:`<template>
  <div class="box">
...
`},{highlight:y(()=>[S]),default:y(()=>[t(I)]),_:1}),t(o)])}}});export{N as __pageData,V as default};
