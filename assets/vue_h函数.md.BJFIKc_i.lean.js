import{d as g,o,y as m,l as E,U as p,V as r,_ as C,f as A,G as s,a1 as B,W as i,a7 as F,X as D,Y as k,a8 as v,u,as as b,k as n}from"./chunks/framework.KSLWugjt.js";import{B as x,A as f,a as d}from"./chunks/theme.3I42yTQ4.js";import{m as c}from"./chunks/index.vd9RWB7E.js";const _={id:"ele"},S=g({__name:"h函数.md.demo.d4444442",setup(t){o(()=>{h()});const h=()=>{const a=document.createElement("div");document.querySelector("#ele").appendChild(a),m(E("div",{innerHTML:"h函数666",style:{color:"red"},class:"test"}),a)};return(a,l)=>(p(),r("div",_))}}),M=C(S,[["__scopeId","data-v-837ca124"]]),V={id:"com"},w=g({__name:"h函数.md.demo.d4444440",setup(t){o(()=>{h()});const h=()=>{const a=document.createElement("div");document.querySelector("#com").appendChild(a),m(E(x,{innerHTML:"按钮",onClick:()=>{alert("按钮点击了")}}),a)};return(a,l)=>(p(),r("div",V))}}),q=C(w,[["__scopeId","data-v-64dc23fb"]]),I=g({__name:"h函数.md.demo.d444443e",setup(t){o(()=>{a()});const h=A(!1),a=()=>{const l=document.createElement("div");document.querySelector("#vmodel").appendChild(l),m(E(f,{checked:h,"onUpdate:checked":y=>{h.value=y}}),l)};return(l,e)=>(p(),r("div",null,[s(B(h.value)+" ",1),e[0]||(e[0]=i("div",{id:"vmodel"},null,-1))]))}}),T=C(I,[["__scopeId","data-v-1285ba62"]]),N=Array.from({length:50},()=>({name:c.mock("@cname"),age:c.Random.integer(8,12),score:c.Random.integer(55,95)})),P=[{title:"Name",dataIndex:"name"},{title:"Age",dataIndex:"age"},{title:"Score",dataIndex:"score"},{title:"Tag",dataIndex:"tag",customRender:t=>{console.log(t);const h=t.record.score;return h>=90?E(d,{innerText:"优",color:"#108EE9"}):h>=80&&h<90?E(d,{innerText:"良",color:"#2DB7F5"}):h<80&&h>=60?E(d,{innerText:"中",color:"#87D068"}):E(d,{innerText:"差",color:"#FF5500"})}}],H={name:"wgh",age:18,sex:1};let L;console.log(H[L]);const R={key:0},$=g({__name:"h函数.md.demo.d444443c",setup(t){return(h,a)=>{const l=F("a-table");return p(),D(l,{columns:u(P),"data-source":u(N)},{bodyCell:k(({column:e,text:y,record:O})=>[e.dataIndex==="name"?(p(),r("a",R,B(y),1)):v("",!0)]),_:1},8,["columns","data-source"])}}}),W=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"vue/h函数.md","filePath":"vue/h函数.md","lastUpdated":1725693536000}'),U={name:"vue/h函数.md"},X=Object.assign(U,{setup(t){return(h,a)=>{const l=F("demo"),e=F("git-talk");return p(),r("div",null,[a[4]||(a[4]=b(`<h2 id="定义" tabindex="-1">定义 <a class="header-anchor" href="#定义" aria-label="Permalink to &quot;定义&quot;">​</a></h2><p>创建虚拟 DOM 节点 (vnode)。</p><h2 id="类型" tabindex="-1">类型 <a class="header-anchor" href="#类型" aria-label="Permalink to &quot;类型&quot;">​</a></h2><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 完整参数签名</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">type</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> Slots</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { [</span><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">name</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">:</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> string</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">]</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">:</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> Slot</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> };</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><h2 id="渲染原生-dom" tabindex="-1">渲染原生 dom <a class="header-anchor" href="#渲染原生-dom" aria-label="Permalink to &quot;渲染原生 dom&quot;">​</a></h2>`,5)),n(l,{customClass:"",sourceCode:`<template>
  <div id="ele"></div>
</template>
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"    }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"style"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:k(()=>[n(M)]),_:1}),a[5]||(a[5]=i("h2",{id:"渲染组件",tabindex:"-1"},[s("渲染组件 "),i("a",{class:"header-anchor",href:"#渲染组件","aria-label":'Permalink to "渲染组件"'},"​")],-1)),n(l,{customClass:"",sourceCode:`<template>
  <div id="com"></div>
</template>
...
`,options:"{}"},{highlight:k(()=>a[1]||(a[1]=[i("div",{class:"language-vue vp-adaptive-theme"},[i("span",{class:"lang"},"vue"),i("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0","v-pre":""},[i("code",null,[i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"<"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"template"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),s(`
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"    }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"style"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:k(()=>[n(q)]),_:1}),a[6]||(a[6]=i("h2",{id:"h-函数中的-双向数据绑定",tabindex:"-1"},[s("h 函数中的 双向数据绑定 "),i("a",{class:"header-anchor",href:"#h-函数中的-双向数据绑定","aria-label":'Permalink to "h 函数中的 双向数据绑定"'},"​")],-1)),n(l,{customClass:"",sourceCode:`<template>
  <div>
    {{ switchValue }}
    <div id="vmodel"></div>
  </div>
...
`,options:"{}"},{highlight:k(()=>a[2]||(a[2]=[i("div",{class:"language-vue vp-adaptive-theme"},[i("span",{class:"lang"},"vue"),i("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0","v-pre":""},[i("code",null,[i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"<"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"template"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),s(`
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"    }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"style"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:k(()=>[n(T)]),_:1}),a[7]||(a[7]=i("h2",{id:"使用场景-ant-design-表格自定义渲染为例",tabindex:"-1"},[s("使用场景(ant design 表格自定义渲染为例) "),i("a",{class:"header-anchor",href:"#使用场景-ant-design-表格自定义渲染为例","aria-label":'Permalink to "使用场景(ant design 表格自定义渲染为例)"'},"​")],-1)),n(l,{customClass:"",sourceCode:`<template>
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:k(()=>[n($)]),_:1}),n(e)])}}});export{W as __pageData,X as default};
