import{f as u,r as c,b as _,v as F,D as C,U as D,V as m,_ as v,W as i,K as s,q as o,Y as A,a7 as B}from"./chunks/framework.D4Mq87kF.js";import"./chunks/mock.DzkNh787.js";import"./chunks/useECharts.Cccr3HoD.js";import{l as w}from"./chunks/map.eml6roOw.js";import{B as M,A as S}from"./chunks/theme.BfutcRqS.js";const L=u({__name:"3.控件.md.demo.669d33ac",setup(f){const E=c(),n=c(!1);_(async()=>{await p(E.value)});async function p(e){const a=await w(),l=new a.Map(e);l.centerAndZoom(new a.Point(116.404,39.915),18),l.addControl(new a.ScaleControl),l.addControl(new a.ZoomControl),l.addControl(new a.NavigationControl3D);const g=new a.LocationControl({anchor:BMAP_ANCHOR_TOP_RIGHT,offset:new a.Size(20,20)});l.addControl(g),g.addEventListener("locationSuccess",function(h){console.log(h)}),l.addControl(new a.CityListControl({anchor:BMAP_ANCHOR_TOP_LEFT}));function r({anchor:h=BMAP_ANCHOR_TOP_LEFT,offset:t=new a.Size(20,60)}={}){this.defaultAnchor=h,this.defaultOffset=t}r.prototype=new a.Control,r.prototype.initialize=function(h){const t=F(M,{innerText:"放大1级",onclick:()=>{h.setZoom(h.getZoom()+1)}}),k=document.createElement("div");return h.getContainer().appendChild(k),C(t,k),k},l.addControl(new r);function d({anchor:h=BMAP_ANCHOR_TOP_LEFT,offset:t=new a.Size(20,120)}={}){this.defaultAnchor=h,this.defaultOffset=t}d.prototype=new a.Control,d.prototype.initialize=function(h){const t=F(S,{checked:n,"onUpdate:checked":async y=>{n.value=y,y?h.enableScrollWheelZoom():h.disableScrollWheelZoom()}}),k=document.createElement("div");return h.getContainer().appendChild(k),C(t,k),k},l.addControl(new d)}return(e,a)=>(D(),m("div",{id:"container",class:"container",ref_key:"container",ref:E},null,512))}}),Z=v(L,[["__scopeId","data-v-32863828"]]),z=JSON.parse('{"title":"控件","description":"","frontmatter":{},"headers":[],"relativePath":"bmap/3.控件.md","filePath":"bmap/3.控件.md","lastUpdated":1726018783000}'),b={name:"bmap/3.控件.md"},N=Object.assign(b,{setup(f){return(E,n)=>{const p=B("demo"),e=B("git-talk");return D(),m("div",null,[n[1]||(n[1]=i("h1",{id:"控件",tabindex:"-1"},[s("控件 "),i("a",{class:"header-anchor",href:"#控件","aria-label":'Permalink to "控件"'},"​")],-1)),o(p,{customClass:"",sourceCode:`<template>
...
`,options:"{}"},{highlight:A(()=>n[0]||(n[0]=[i("div",{class:"language-vue vp-adaptive-theme"},[i("span",{class:"lang"},"vue"),i("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0","v-pre":""},[i("code",null,[i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"<"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"template"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),s(`
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"style"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:A(()=>[o(Z)]),_:1}),o(e)])}}});export{z as __pageData,N as default};
