import{d as u,f as c,o as _,l as F,y as C,U as m,V as D,_ as v,W as i,G as s,k as o,Y as A,a7 as B}from"./chunks/framework.KSLWugjt.js";import{l as w}from"./chunks/map.eml6roOw.js";import{B as M,A as S}from"./chunks/theme.3I42yTQ4.js";const L=u({__name:"3.控件.md.demo.669d33ac",setup(f){const E=c(),n=c(!1);_(async()=>{await p(E.value)});async function p(e){const a=await w(),l=new a.Map(e);l.centerAndZoom(new a.Point(116.404,39.915),18),l.addControl(new a.ScaleControl),l.addControl(new a.ZoomControl),l.addControl(new a.NavigationControl3D);const y=new a.LocationControl({anchor:BMAP_ANCHOR_TOP_RIGHT,offset:new a.Size(20,20)});l.addControl(y),y.addEventListener("locationSuccess",function(h){console.log(h)}),l.addControl(new a.CityListControl({anchor:BMAP_ANCHOR_TOP_LEFT}));function r({anchor:h=BMAP_ANCHOR_TOP_LEFT,offset:t=new a.Size(20,60)}={}){this.defaultAnchor=h,this.defaultOffset=t}r.prototype=new a.Control,r.prototype.initialize=function(h){const t=F(M,{innerText:"放大1级",onclick:()=>{h.setZoom(h.getZoom()+1)}}),k=document.createElement("div");return h.getContainer().appendChild(k),C(t,k),k},l.addControl(new r);function d({anchor:h=BMAP_ANCHOR_TOP_LEFT,offset:t=new a.Size(20,120)}={}){this.defaultAnchor=h,this.defaultOffset=t}d.prototype=new a.Control,d.prototype.initialize=function(h){const t=F(S,{checked:n,"onUpdate:checked":async g=>{n.value=g,g?h.enableScrollWheelZoom():h.disableScrollWheelZoom()}}),k=document.createElement("div");return h.getContainer().appendChild(k),C(t,k),k},l.addControl(new d)}return(e,a)=>(m(),D("div",{id:"container",class:"container",ref_key:"container",ref:E},null,512))}}),Z=v(L,[["__scopeId","data-v-46fa645e"]]),T=JSON.parse('{"title":"控件","description":"","frontmatter":{},"headers":[],"relativePath":"bmap/3.控件.md","filePath":"bmap/3.控件.md","lastUpdated":1725693536000}'),b={name:"bmap/3.控件.md"},W=Object.assign(b,{setup(f){return(E,n)=>{const p=B("demo"),e=B("git-talk");return m(),D("div",null,[n[1]||(n[1]=i("h1",{id:"控件",tabindex:"-1"},[s("控件 "),i("a",{class:"header-anchor",href:"#控件","aria-label":'Permalink to "控件"'},"​")],-1)),o(p,{customClass:"",sourceCode:`<template>
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"style"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:A(()=>[o(Z)]),_:1}),o(e)])}}});export{T as __pageData,W as default};
