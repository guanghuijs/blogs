import{l as y}from"./chunks/map._qUit9OZ.js";import{d as c,f as F,o,V as E,W as r,a5 as C,k as h,$ as e,an as m,ae as p,X as s,E as i}from"./chunks/framework.bXfzgsRM.js";const B=c({__name:"1.百度地图初始化.md.demo.2ccd972a",setup(d){const l=F();o(async()=>{await k(l.value)});async function k(n){const a=await y(),t=new a.Map(n,{enableDblclickZoom:!0,enableMapClick:!1,displayOptions:{building:!1},enableRotate:!1,enableTilt:!1}),g=new a.Point(99.657606,27.302755);t.centerAndZoom(g,18),t.enableScrollWheelZoom(!0)}return(n,a)=>(E(),r("div",{id:"container",class:"container",ref_key:"container",ref:l},null,512))}}),b=C(B,[["__scopeId","data-v-619d7dba"]]),u=m("",4),A=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes github-light github-dark vp-code","v-pre":""},[s("code",null,[s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"<"),s("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"template"),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),i(`
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  }")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),s("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"style"),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1),M=JSON.parse('{"title":"初始化","description":"","frontmatter":{},"headers":[],"relativePath":"bmap/1.百度地图初始化.md","filePath":"bmap/1.百度地图初始化.md","lastUpdated":1708770940000}'),D={name:"bmap/1.百度地图初始化.md"},v=Object.assign(D,{setup(d){return(l,k)=>{const n=p("demo"),a=p("git-talk");return E(),r("div",null,[u,h(n,{customClass:"",sourceCode:`<template>
