import"./chunks/mock.DzkNh787.js";import"./chunks/useECharts.Cccr3HoD.js";import{l as M}from"./chunks/map.eml6roOw.js";import{f,r as b,b as w,U as o,V as c,_,W as i,K as s,q as p,Y as g,a7 as F}from"./chunks/framework.D4Mq87kF.js";import"./chunks/theme.BfutcRqS.js";const G=f({__name:"6.区域模式.md.demo.4287144d",setup(C){const t=b();w(async()=>{await h(t.value)});async function h(l){const a=await M(),k=new a.Map(l,{enableDblclickZoom:!0,enableMapClick:!1,displayOptions:{building:!1},enableRotate:!1,enableTilt:!1}),B=new a.Point(104.10663034748738,24.714727851308414);k.centerAndZoom(B,11),k.enableScrollWheelZoom(!0),new a.Boundary().get("师宗",function(r){for(let n=0;n<r.boundaries.length;n++){const d=r.boundaries[n].split(";"),e=[];for(let E=0;E<d.length;E++){const y=d[E].split(","),u=new a.Point(y[0],y[1]);e.push(u)}const m=new a.MapMask(e,{isBuildingMask:!0,isPoiMask:!0,isMapMask:!0,showRegion:"inside",topFillColor:"#5679ea",topFillOpacity:.5,sideFillColor:"#5679ea",sideFillOpacity:.9});k.addOverlay(m);const D=new a.Polyline(e,{strokeColor:"#4ca7a2",strokeWeight:3,strokeOpacity:1});k.addOverlay(D)}const A=new a.Marker3D(new a.Point(104.10663034748738,24.714727851308414),1e3,{size:50,shape:"BMAP_SHAPE_CIRCLE",fillColor:"#454399",fillOpacity:.6});k.addOverlay(A),k.addOverlay(new a.Marker3D(new a.Point(104.00021214529644,24.836091208203417),Math.round(Math.random())*6e3,{size:50,icon:new a.Icon("https://img1.baidu.com/it/u=2399966577,1808536528&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=492",new a.Size(30,50))}))})}return(l,a)=>(o(),c("div",{id:"container",class:"container",ref_key:"container",ref:t},null,512))}}),L=_(G,[["__scopeId","data-v-c5dedf0d"]]),z=JSON.parse('{"title":"区域模式","description":"","frontmatter":{},"headers":[],"relativePath":"bmap/6.区域模式.md","filePath":"bmap/6.区域模式.md","lastUpdated":1726018783000}'),v={name:"bmap/6.区域模式.md"},Z=Object.assign(v,{setup(C){return(t,h)=>{const l=F("demo"),a=F("git-talk");return o(),c("div",null,[h[1]||(h[1]=i("h1",{id:"区域模式",tabindex:"-1"},[s("区域模式 "),i("a",{class:"header-anchor",href:"#区域模式","aria-label":'Permalink to "区域模式"'},"​")],-1)),p(l,{customClass:"",sourceCode:`<template>
...
`,options:"{}"},{highlight:g(()=>h[0]||(h[0]=[i("div",{class:"language-vue vp-adaptive-theme"},[i("span",{class:"lang"},"vue"),i("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0","v-pre":""},[i("code",null,[i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"<"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"template"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),s(`
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#D73A49","--shiki-dark":"#F97583"}},"  import"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}}," { loadBMapGL } "),i("span",{style:{"--shiki-light":"#D73A49","--shiki-dark":"#F97583"}},"from"),i("span",{style:{"--shiki-light":"#032F62","--shiki-dark":"#9ECBFF"}}," '@packages/utils'"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},";")]),s(`
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"style"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:g(()=>[p(L)]),_:1}),p(a)])}}});export{z as __pageData,Z as default};
