import{d as u,f as c,o as _,l as F,y as C,U as m,V as D,a0 as v,k as o,_ as A,a5 as i,G as s,ac as B}from"./chunks/framework.zd0jknkR.js";import{l as w}from"./chunks/map.eml6roOw.js";import{B as M,A as S}from"./chunks/theme.B0_mNSvv.js";const L=u({__name:"3.控件.md.demo.669d33ac",setup(f){const e=c(),E=c(!1);_(async()=>{await p(e.value)});async function p(k){const a=await w(),l=new a.Map(k);l.centerAndZoom(new a.Point(116.404,39.915),18),l.addControl(new a.ScaleControl),l.addControl(new a.ZoomControl),l.addControl(new a.NavigationControl3D);const y=new a.LocationControl({anchor:BMAP_ANCHOR_TOP_RIGHT,offset:new a.Size(20,20)});l.addControl(y),y.addEventListener("locationSuccess",function(h){console.log(h)}),l.addControl(new a.CityListControl({anchor:BMAP_ANCHOR_TOP_LEFT}));function r({anchor:h=BMAP_ANCHOR_TOP_LEFT,offset:n=new a.Size(20,60)}={}){this.defaultAnchor=h,this.defaultOffset=n}r.prototype=new a.Control,r.prototype.initialize=function(h){const n=F(M,{innerText:"放大1级",onclick:()=>{h.setZoom(h.getZoom()+1)}}),t=document.createElement("div");return h.getContainer().appendChild(t),C(n,t),t},l.addControl(new r);function d({anchor:h=BMAP_ANCHOR_TOP_LEFT,offset:n=new a.Size(20,120)}={}){this.defaultAnchor=h,this.defaultOffset=n}d.prototype=new a.Control,d.prototype.initialize=function(h){const n=F(S,{checked:E,"onUpdate:checked":async g=>{E.value=g,g?h.enableScrollWheelZoom():h.disableScrollWheelZoom()}}),t=document.createElement("div");return h.getContainer().appendChild(t),C(n,t),t},l.addControl(new d)}return(k,a)=>(m(),D("div",{id:"container",class:"container",ref_key:"container",ref:e},null,512))}}),Z=v(L,[["__scopeId","data-v-46fa645e"]]),b=i("h1",{id:"控件",tabindex:"-1"},[s("控件 "),i("a",{class:"header-anchor",href:"#控件","aria-label":'Permalink to "控件"'},"​")],-1),G=i("div",{class:"language-vue vp-adaptive-theme"},[i("span",{class:"lang"},"vue"),i("pre",{class:"shiki shiki-themes github-light github-dark vp-code",tabindex:"0","v-pre":""},[i("code",null,[i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"<"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"template"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),s(`
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"style"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1),z=JSON.parse('{"title":"控件","description":"","frontmatter":{},"headers":[],"relativePath":"bmap/3.控件.md","filePath":"bmap/3.控件.md","lastUpdated":1725328303000}'),O={name:"bmap/3.控件.md"},N=Object.assign(O,{setup(f){return(e,E)=>{const p=B("demo"),k=B("git-talk");return m(),D("div",null,[b,o(p,{customClass:"",sourceCode:`<template>
...
`,options:"{}"},{highlight:A(()=>[G]),default:A(()=>[o(Z)]),_:1}),o(k)])}}});export{z as __pageData,N as default};
