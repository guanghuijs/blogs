import{d as g,k as F,r as m,N as e,o as E,b as r,a5 as C,j as D,i as s,t as B,x as _,y as v,f as i,ae as o,q as b,h as t,s as x,p as u,c as k,an as f}from"./chunks/framework.nAclW6lK.js";import{B as S,A as M,a as d}from"./chunks/theme.eg9onghF.js";import{m as c}from"./chunks/index.lgw_Fdy9.js";const V={id:"ele"},w=g({__name:"h函数.md.demo.659f83c8",setup(l){F(()=>{a()});const a=()=>{const n=document.createElement("div");document.querySelector("#ele").appendChild(n),m(e("div",{innerHTML:"h函数666",style:{color:"red"},class:"test"}),n)};return(n,h)=>(E(),r("div",V))}}),T=C(w,[["__scopeId","data-v-23438246"]]),I={id:"com"},q=g({__name:"h函数.md.demo.659f83c6",setup(l){F(()=>{a()});const a=()=>{const n=document.createElement("div");document.querySelector("#com").appendChild(n),m(e(S,{innerHTML:"按钮",onClick:()=>{alert("按钮点击了")}}),n)};return(n,h)=>(E(),r("div",I))}}),N=C(q,[["__scopeId","data-v-4cc2d3e6"]]),P=l=>(_("data-v-b7548c98"),l=l(),v(),l),$=P(()=>i("div",{id:"vmodel"},null,-1)),R=g({__name:"h函数.md.demo.659f83c4",setup(l){F(()=>{n()});const a=D(!1),n=()=>{const h=document.createElement("div");document.querySelector("#vmodel").appendChild(h),m(e(M,{checked:a,"onUpdate:checked":y=>{a.value=y}}),h)};return(h,p)=>(E(),r("div",null,[s(B(a.value)+" ",1),$]))}}),H=C(R,[["__scopeId","data-v-b7548c98"]]),L=Array.from({length:50},()=>({name:c.mock("@cname"),age:c.Random.integer(8,12),score:c.Random.integer(55,95)})),U=[{title:"Name",dataIndex:"name"},{title:"Age",dataIndex:"age"},{title:"Score",dataIndex:"score"},{title:"Tag",dataIndex:"tag",customRender:l=>{console.log(l);const a=l.record.score;return a>=90?e(d,{innerText:"优",color:"#108EE9"}):a>=80&&a<90?e(d,{innerText:"良",color:"#2DB7F5"}):a<80&&a>=60?e(d,{innerText:"中",color:"#87D068"}):e(d,{innerText:"差",color:"#FF5500"})}}],A={name:"wgh",age:18,sex:1};function j(l,a){return l[a]}j(A,"name");let O;console.log(A[O]);const J={key:0},z=g({__name:"h函数.md.demo.659f83c2",setup(l){return(a,n)=>{const h=o("a-table");return E(),b(h,{columns:u(U),"data-source":u(L)},{bodyCell:t(({column:p,text:y,record:ai})=>[p.dataIndex==="name"?(E(),r("a",J,B(y),1)):x("",!0)]),_:1},8,["columns","data-source"])}}}),G=f(`<h2 id="定义" tabindex="-1">定义 <a class="header-anchor" href="#定义" aria-label="Permalink to &quot;定义&quot;">​</a></h2><p>创建虚拟 DOM 节点 (vnode)。</p><h2 id="类型" tabindex="-1">类型 <a class="header-anchor" href="#类型" aria-label="Permalink to &quot;类型&quot;">​</a></h2><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 完整参数签名</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">type</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> Slots</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { [</span><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">name</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">:</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> string</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">]</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">:</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> Slot</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> };</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><h2 id="渲染原生-dom" tabindex="-1">渲染原生 dom <a class="header-anchor" href="#渲染原生-dom" aria-label="Permalink to &quot;渲染原生 dom&quot;">​</a></h2>`,5),K=i("div",{class:"language-vue vp-adaptive-theme"},[i("span",{class:"lang"},"vue"),i("pre",{class:"shiki shiki-themes github-light github-dark vp-code","v-pre":""},[i("code",null,[i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"<"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"template"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),s(`
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"    }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"style"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1),Q=i("h2",{id:"渲染组件",tabindex:"-1"},[s("渲染组件 "),i("a",{class:"header-anchor",href:"#渲染组件","aria-label":'Permalink to "渲染组件"'},"​")],-1),W=i("div",{class:"language-vue vp-adaptive-theme"},[i("span",{class:"lang"},"vue"),i("pre",{class:"shiki shiki-themes github-light github-dark vp-code","v-pre":""},[i("code",null,[i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"<"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"template"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),s(`
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1),ki=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"blogs/vue/h函数.md","filePath":"blogs/vue/h函数.md","lastUpdated":1704447032000}'),si={name:"blogs/vue/h函数.md"},ti=Object.assign(si,{setup(l){return(a,n)=>{const h=o("demo"),p=o("git-talk");return E(),r("div",null,[G,k(h,{customClass:"",sourceCode:`<template>
  <div id="ele"></div>
</template>
...
`},{highlight:t(()=>[K]),default:t(()=>[k(T)]),_:1}),Q,k(h,{customClass:"",sourceCode:`<template>
  <div id="com"></div>
</template>
...
`},{highlight:t(()=>[W]),default:t(()=>[k(N)]),_:1}),X,k(h,{customClass:"",sourceCode:`<template>
  <div>
    {{ switchValue }}
    <div id="vmodel"></div>
  </div>
...
<\/script>
`},{highlight:t(()=>[ii]),default:t(()=>[k(z)]),_:1}),k(p)])}}});export{ki as __pageData,ti as default};
